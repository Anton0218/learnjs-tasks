...
разделённых запятой. Ваш toString не должен выводиться при итерации 
объекта с помощью цикла for..in.*/

let dictionary = Object.create(null, { // ваш код, который добавляет метод dictionary.toString
  toString: { value() { 
