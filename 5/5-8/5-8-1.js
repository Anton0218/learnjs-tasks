...
let messagesColl = new WeakMap();

//в случае прочтения сообщения:
messagesColl.add(messages[0]); // вместо 0 - индекс прочитанного сообщения
messagesColl.has(messages[0]); //проверка прочитано или нет

//либо добавление символьных ключей в массив к объектам о статусе прочитано или нет